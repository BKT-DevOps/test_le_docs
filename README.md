...
[![GitHub](https://img.shields.io/badge/GitHub-BKT-DevOps-181717?style=flat-square&logo=github)](https://github.com/BKT-DevOps/test_le_docs)
...
```bash
git clone https://github.com/BKT-DevOps/test_le_docs.git
cd test_le_docs
